...
```
 ...
 ```json
 {"mtype":"error", "from":"tilt_sensor", "to": "*", "error":"calibration_failed", "reason":"unstable"}.
 ```
...
1.  **Test Case ID:** `T-CONFIG-01`
    ...
    *   **Input Message:**
        ```json
        {"mtype":"config", "from":"tester", "to":"tilt_sensor", "name":"number_sample", "value":7}
        ```
    *   **Expected Output/Behavior ("Oracle"):**
        ...
        *   Module sends a JSON response:
            ```json
            {"mtype":"status", "from":"tilt_sensor", "to":"tester", "status":"config_updated", "parameter":{"name":"number_sample", "value":7}, "message":"applied"}
            ```
...
2.  **Test Case ID:** `T-CONFIG-02`
    ...
    *   **Input Message:**
        ```json
        {"mtype":"config", "from":"tester", "to":"tilt_sensor", "name":"number_sample", "value":30}
        ```
    *   **Expected Output/Behavior ("Oracle"):**
...
3.  **Test Case ID:** `T-CONFIG-03`
    ...
    *   **Input Message:**
        ```json
        {"mtype":"config", "from":"tester", "to":"tilt_sensor", "name":"frequency_hz", "value":5}
        ```
    *   **Expected Output/Behavior ("Oracle"):**
...
4.  **Test Case ID:** `T-CONFIG-04`
    ...
    *   **Input Message:**
        ```json
        {"mtype":"config", "from":"tester", "to":"tilt_sensor", "name":"threshold", "value":3.0}
        ```
    *   **Expected Output/Behavior ("Oracle"):**
...
5.  **Test Case ID:** `T-CONFIG-05`
    ...
    *   **Input Message:**
        ```json
        {"mtype":"config", "from":"tester", "to":"tilt_sensor", "name":"calibrate"}
        ```
    *   **Expected Output/Behavior ("Oracle"):**
...
1.  **Test Case ID:** `T-INPUT-01`
    ...
    *   **Input Message:**
        ```json
        {"mtype":"tilt_sensor.start", "from":"tester", "to":"tilt_sensor"}
        ```
    *   **Expected Output/Behavior ("Oracle"):**
...
3.  **Test Case ID:** `T-INPUT-03`
    ...
    *   **Input Message:**
        ```json
        {"mtype":"tilt_sensor.stop", "from":"tester", "to":"tilt_sensor"}
        ```
    *   **Expected Output/Behavior ("Oracle"):**
...
1.  **Test Case ID:** `T-ERROR-01`
    ...
    *   **Input Message (sent over Serial):**
        ```
        {"mtype":"config", "from":"tester", "to":"tilt_sensor", "name":"threshold", "value":5.0
        ```
    *   **Expected Output/Behavior ("Oracle"):**
...
2.  **Test Case ID:** `T-ERROR-02`
    ...
    *   **Input Message:**
        ```json
        {"from":"tester", "to":"tilt_sensor", "name":"threshold", "value":5.0}
        ```
    *   **Expected Output/Behavior ("Oracle"):**
...
3.  **Test Case ID:** `T-ERROR-03`
    ...
    *   **Input Message:**
        ```json
        {"mtype":"config", "from":"tester", "to":"tilt_sensor", "name":"unknown_param", "value":10}
        ```
    *   **Expected Output/Behavior ("Oracle"):**
